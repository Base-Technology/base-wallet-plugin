  ...
  return (
    <AcyPageWrapper title="Networks">
      <Box sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
        <List>
          <CustomListItem text="Declare Smart Contract" to="#/settings/developersettings/smartcontractdevelopment/declare" />
          <CustomListItem text="Deploy Smart Contract" to="#/settings/developersettings/smartcontractdevelopment/develop" />
        </List>
