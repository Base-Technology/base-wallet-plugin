...
export default function BasicList() {
    ...
    return (
        <AcyPageWrapper title="Declare smart contract">
            <Box sx={{ '& .MuiInputBase-root': { marginBottom: '15px' } }}>
                <TextField fullWidth id="outlined-basic" label="Click To Upload Contract JSON" variant="outlined" />
            ...
            <Box sx={{ padding: '16px 0 24px ', textAlign: 'center' }}>
                <Button sx={{ width: '80%', borderRadius: '9999px',padding:'12px 16px'}} variant="contained">Declare</Button>
            </Box>
        </AcyPageWrapper>
    );
}