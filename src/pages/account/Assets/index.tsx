...
const DocsPage = () => {
  return (
    ...
    >
      ...
      <AcyCopy>{JSON.parse(localStorage.getItem("UserAddress")!)}</AcyCopy>
      <Tooltip title="view">
        <IconButton
          sx={{ color: "#9f9fa1" }}
          size="small"
        ...
        >
          ...
          {/* <ListItemButton>
            <ListItemIcon>
              <img
                width={40}
                src="https://app.acy.finance/static/icon_acy.78c0179c.svg"
              />
            </ListItemIcon>
            <Box
              sx={{
          ...
          <ListItemButton>
            <ListItemIcon>
              <img
                width={40}
                src="https://cryptologos.cc/logos/polygon-matic-logo.svg?v=017"
              />
            </ListItemIcon>
            <Box
              sx={{
          ...
          <ListItemButton>
            <ListItemIcon>
              <img
                width={40}
                src="https://storageapi2.fleek.co/chwizdo-team-bucket/ACY Token List/USDT.svg"
              />
            </ListItemIcon>
            <Box
              sx={{
          ...
          <ListItemButton>
            <ListItemIcon>
              <img
                width={40}
                src="https://storageapi2.fleek.co/chwizdo-team-bucket/ACY Token List/USDC.svg"
              />
            </ListItemIcon>
            <Box
              sx={{
